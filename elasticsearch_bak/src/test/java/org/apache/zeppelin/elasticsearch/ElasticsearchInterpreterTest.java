...
public class ElasticsearchInterpreterTest {
  ...
  private static TransportClient elsClient;
  ...
  private static final String ELS_CLUSTER_NAME = "elasticsearch_binh-jax";
  private static final String ELS_HOST = "localhost";
  private static final String ELS_TRANSPORT_PORT = "9300";
  private static final String ELS_HTTP_PORT = "9200";
  ...
  public static void populate() throws IOException {
    ...
    elsClient = new PreBuiltTransportClient(settings)
            .addTransportAddress(new TransportAddress(InetAddress.getByName("localhost"), 9300));


    elsClient.admin().indices().prepareCreate("logs").addMapping("http",jsonBuilder()
